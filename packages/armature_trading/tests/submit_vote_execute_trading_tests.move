...
module armature_trading::submit_vote_execute_trading_tests {
    ...
    fun test_sve_deposit_coin_to_book() {
        ...
        test.next_tx(ADMIN);
        {
            ...
            let ticket = board_voting::submit_vote_execute<
                deposit_coin_to_book::DepositCoinToBook<QUOTE>,
            >(
                &mut dao,
    ...
    fun test_sve_sweep_coin_to_treasury() {
        ...
        test.next_tx(ADMIN);
        {
            ...
            let ticket = board_voting::submit_vote_execute<
                sweep_coin_to_treasury::SweepCoinToTreasury<QUOTE>,
            >(
                &mut dao,
    ...
    fun test_sve_place_limit_order_coin_pool() {
        ...
        test.next_tx(ADMIN);
        {
            ...
            let ticket = board_voting::submit_vote_execute<
                place_limit_order_coin::PlaceLimitOrderCoin<BASE, QUOTE>,
            >(
                &mut dao,
    ...
    fun test_sve_cancel_order_coin_pool() {
        ...
        test.next_tx(ADMIN);
        {
            ...
            let ticket = board_voting::submit_vote_execute<
                cancel_order_coin::CancelOrderCoin<BASE, QUOTE>,
            >(
                &mut dao,
    ...
    fun test_sve_place_limit_order_multicoin_pool() {
        ...
        test.next_tx(ADMIN);
        {
            ...
            let ticket = board_voting::submit_vote_execute<
                place_limit_order::PlaceLimitOrder<QUOTE>,
            >(
                &mut dao,
    ...
    fun test_sve_create_multicoin_pool() {
        ...
        test.next_tx(ADMIN);
        {
            ...
            let ticket = board_voting::submit_vote_execute<
                create_multicoin_pool::CreateMulticoinPool<QUOTE>,
            >(
                &mut dao,
